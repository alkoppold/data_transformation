...
df_ref <- data_extract %>% select(rationale_given = 46, rationale_type = 47)
...
#data.frame(colname = data_extract %>% colnames()) %>% mutate(colnum = 1:n()) %>% relocate(colnum)
df_check = data_extract %>% select(22:33, 52)
...
df_cake <- df_check %>% select(1, 4, 6, 9, 11)
...
df_cake_stats <- df_check %>% select(13)
