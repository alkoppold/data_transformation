...
eine Frage -> dann Sanky mit Antwort und Anzahl
e.g., Was the normal distribution checked?, If yes, how?, before/after, etc.
...
Habe dafür schon einen Plot (ähnlich wie bei content analyse)
