...
``` {r load data}
data_long = read_rds("data/Reutter_hr_transformations.rds")
```
...
from  <- c(xmin = 1, xmax = 11, ymin = 750, ymax = 950)
to  <- c(xmin = 0, xmax = 13, ymin = 1000, ymax = 1400)
lineplot_scr_raw_zoom +geom_magnify(from = from, to = to,corners = 0.1, shadow = T)
