---
title: "Task_Force_SpecCurve-FPS"
...
``` {r load-prepare-data}
data_multiverse = read_rds("data/Klingelh_FPS_multiverse.rds")
...
s_effect <- ggplot(data_multi_es, aes(x = approach_eff_order, y = range_cor)) +
  ...
  scale_y_discrete(name = 'Range correction', labels = c("none", "CS corrected")) +
    scale_x_continuous(limits = c(0,11), breaks = c(1:10)) +
